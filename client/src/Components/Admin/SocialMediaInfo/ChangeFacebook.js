...
const OfficialFacebook = () => {
  ...
  return (
    <>
        ...
        <Helmet>
                <meta charSet="utf-8" />
                <title>Change Facebook Id</title>
          ...
          <div className="row justify-content-center">
            ...
            >
              <h3 className="text-center" style={{ marginBottom: "4rem" }}>
                Change Site's Official Facebook Id
              </h3>
              <div
              ...
              >
                <div className="row">
                  ...
                  <div className="col-lg-8">
                    <form
                      action="/changeOfficialfacebookId"
                      method="post"
                    >
...
export default OfficialFacebook;
