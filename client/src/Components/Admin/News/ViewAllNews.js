...
const NewsList = () => {
  ...
  const handleDeleteSelected = () => {
    axios
      ...
      .post("/deleteSelectedBankOffers", { ids: selectedItems })
                      ...
                      <>
                        <tbody>
                          <tr className="bg-light">
                            ...
                            <td>
                              <form method="POST" action="/deleteBankOffer">
                                <input
                                  type="hidden"
                                  name="id"
                                  value={_id}
