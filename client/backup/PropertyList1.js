...
const PropertyList = () => {
      ...
      for (let category of categories) {
        if (
          ...
          field.bhkNumber
            ...
            .includes(String(category).toLowerCase()) ||
          // field.isVerified.includes(category) ||
  ...
  useEffect(() => {
    ...
    // Update totalItems state when all checkboxes are unchecked
                ...
                <div className="widget widget-range">
                  <div className="widget-body">
                    ...
                    <div className="form-check d-flex">
                      <h3 style={{ fontSize: "1.1rem", marginLeft: "-1.3rem" }}>
                        Verified Properties
                      </h3>
                      <div
                    ...
                    <div className="form-check">
                      ...
                      <label>
                        <input
                          ...
                          className="item_filter rera"
                          onChange={(e) => {
                            checkboxChange(e, "not_available");
                          }}
                        />{" "}
                        <span className="label-text">Not Available</span>
                      </label>
                    </div>
                    <h3 style={{ fontSize: "1.1rem" }}>Budget</h3>
                    <div className="row">
                      <div className="col-sm-12">
                        {/* <div id="slider-range" /> */}
                        <Slider style={{ width: "90%", margin: "0 1rem" }}
                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        {/* <div id="slider-range" /> */}
                        <Slider style={{ width: "90%", margin: "0 1rem" }}
                          getAriaLabel={() => "Area range (0 to 4000 Sq. ft. crore)"} // updated aria label
                          value={areaValue}
                    ...
                    {/* </form> */}
                    <hr />
                    <h3 style={{ fontSize: "1.1rem" }}>Posted By</h3>
                    <div className="form-check">
                      <label>
                        <input
                          type="checkbox"
                    ...
                    <hr />
                    <h3 style={{ fontSize: "1.1rem" }}>Sale Type</h3>
                    <div className="form-check">
                      <label>
                        <input
                          type="checkbox"
                    ...
                    <h3 style={{ fontSize: "1.1rem" }}>No. Of Bedrooms</h3>
                    <div className="form-check">
                      <label>
                        <input
                          type="checkbox"
                    ...
                    <h3 style={{ fontSize: "1.1rem" }}>Construction Status</h3>
                    <div className="form-check">
                      <label>
                        <input
                          type="checkbox"
                    ...
                    <hr />
                    <h3 style={{ fontSize: "1.1rem" }}>Property Type</h3>
                    ...
                    <h3 style={{ fontSize: "1.1rem" }}>Localities</h3>
                    <div className="form-group">
                      <div className="form-check">
                        <label>
                          {" "}
                    ...
                    <h3 style={{ fontSize: "1.1rem" }}>Furnishing Status</h3>
                    <div className="form-check">
                      <label>
                        <input
                          type="checkbox"
                    ...
                    {/* <h3 style={{ fontSize: "1.1rem" }}>Amentites</h3>
                    <div className="form-check">
                      <label>
                        <input
                          type="checkbox"
