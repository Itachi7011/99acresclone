  ...
  const filterData = (data, currentPage, itemsPerPage) => {
    ...
    return data.filter((field, index) => {
      ...
      for (let category of categories) {
        if (
          field.propertySubLocality

            .toLowerCase()

            .includes(String(category.locality).toLowerCase()) ||
                  ...
                  <div className="widget-body">
                    <form>
                      <div className="form-check">
                        <h3
                          style={{ fontSize: "1.1rem", marginLeft: "-1.3rem" }}
                        >
                          Rera Approval
                        </h3>
                          ...
                          for (let category of categories) {
                            if (
                              field.propertySubLocality
                                .toLowerCase()
                                .includes(
                                  String(category.locality).toLowerCase()
                                ) ||
                              field.propertySubType1
                                .toLowerCase()
                                .includes(String(category).toLowerCase()) ||
