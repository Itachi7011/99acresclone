...
const PostNewCommercialProperty = () => {
  ...
  const [image, setImage] = useState({ photograph: "" });
  ...
  const convertToBase64 = async (e) => {
    ...
    reader.onload = () => {
      ...
      setImage({ photograph: reader.result });
    };
  ...
  console.log("image is : ", image.photograph);
    ...
    <>
      <div className="main-body1">
        <div className="registrationForm">
          ...
          <form action="/postNewCommercialProperty" method="POST">
            ...
            <div className="formDivRegistraion">
              ...
              <select style={{ width: "20rem" }}>
                <option name="bhkNumber" value="1 BHK">
                  1 BHK
                </option>
                <option name="bhkNumber" value="2 BHK">
                  2 BHK
                </option>
                <option name="bhkNumber" value="3 BHK">
                  3 BHK
                </option>
                <option name="bhkNumber" value="4 BHK">
                  4 BHK
                </option>
                <option name="bhkNumber" value="5 BHK">
                  5 BHK
                </option>
              </select>
            </div>
